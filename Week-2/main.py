...
# Load the CSV data
data = pd.read_csv('C:/Users/sai ganesh/PycharmProjects/EnvironmentalData/environment_data.csv')
...
data.to_csv('C:/Users/sai ganesh/PycharmProjects/EnvironmentalData/preprocessed_data.csv', index=False)
